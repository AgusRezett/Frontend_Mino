        ...
        <aside className="side-navbar-container">
            <ul id="sideNavbarContainer" className="side-navbar-links">
                <li>
                    <NavLink
                        to="/"
                        onClick={(e) => pressNavigateButton(e.target)}
                    >
                        <svg
                            className="nav-element-icon"
                            viewBox="0 0 24 24"
                            strokeWidth="1"
                            strokeLinecap="round"
                ...
                <li>
                    ...
                    >
                        ...
                        <span>
                            <FormattedMessage
                                id="navbar.option.wallets"
                                defaultMessage="Cuentas vinculadas"
                            />
                        </span>
                    </NavLink>
                </li>
                <li>
                    ...
                    >
                        <svg
                            className="nav-element-icon-special"
                            viewBox="0 0 128 128"
                            strokeWidth="1"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        ...
                        <span>
                            <FormattedMessage
                                id="navbar.option.crypto"
                                defaultMessage="Criptomonedas"
                            />
                        </span>
                    </NavLink>
                </li>
                <li>
                    ...
                    >
                        ...
                        <span>
                            <FormattedMessage
                                id="navbar.option.configuration"
                ...
                <li className="log-out">
                    <a onClickCapture={endUserSession} href="/.">
                        <svg
                            className="nav-element-icon-special log-out-icon"
                ...
                <div
                    id="activeNavlinkBackground"
                    className="active-navlink-background"
                >
