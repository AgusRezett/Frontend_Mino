            ...
            <ul id="sideNavbarContainer" className="side-navbar-links">
                <li>
                    <NavLink to="/" onClick={(e) => pressNavigateButton(e.target)}>
                        ...
                        <span>
                            <FormattedMessage id="navbar.option.home" defaultMessage="Inicio" />
                        </span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/billeteras" onClick={(e) => pressNavigateButton(e.target)}>
                        ...
                        <span>
                            <FormattedMessage id="navbar.option.wallets" defaultMessage="Cuentas vinculadas" />
                        </span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/criptomonedas" onClick={(e) => pressNavigateButton(e.target)}>
                        ...
                        <span>
                            <FormattedMessage id="navbar.option.crypto" defaultMessage="Criptomonedas" />
                        </span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/configuracion" onClick={(e) => pressNavigateButton(e.target)}>
                        ...
                        <span>
                            <FormattedMessage id="navbar.option.configuration" defaultMessage="Configuración" />
                        </span>
                    </NavLink>
                </li>
